...
protocol AlbumPickerTableViewControllerDelegate: class {
...
class FacebookAlbumPicker: UITableViewController {
    ...
    fileprivate func prepareTableView() {
        ...
        self.title = FacebookImagePicker.pickerConfig.title
    ...
    fileprivate func doFacebookLogin() {
        FacebookHelper.shared.login(controller: self) { (success, error) in
            if !success {
                // Something wrong
    ...
    override public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = AlbumTableViewCell(style: .subtitle, reuseIdentifier: self.reuseIdentifier)
        }
...
extension FacebookAlbumPicker: AlbumPickerTableViewControllerDelegate {
